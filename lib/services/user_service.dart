...
import 'package:flutter_dotenv/flutter_dotenv.dart'; // <--- IMPORTACIÓN AÑADIDA
...
class UserService {
  ...
  Future<String> uploadProfilePictureToImgbb(XFile imageFile) async {
    // [CAMBIO REALIZADO] Se lee la clave de API de forma segura desde el archivo .env
  ...
  /// Obtiene un Stream con la lista de todos los usuarios de la aplicación.
